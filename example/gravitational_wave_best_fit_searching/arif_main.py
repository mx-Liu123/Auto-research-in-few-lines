...
def main():
    ...
    main_prompt = (
        ...
        "- NOTE: We abandoned the initial Fisher matrix because it is often UNRELIABLE for IMRI; it predicts identical narrow biases for m1 and m2 despite their vastly different magnitudes.\n"
        ...
        "7. LOADING PREVIOUS RESULTS: You can (and should) load previously optimized parameters from 'optimized_params_IMRI_0PA.npy' (or the 1PA version) as your starting point to continue refinement across experiments.\n"
