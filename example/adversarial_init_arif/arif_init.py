...
HOW_TO_RUN_YOUR_CODE = "xxx/venv/python strategy.py" # Hint to use correct venv python
...
def main():
    ...
    reviewer_ans = reviewer_agent.ask(
        task_background + your_idea_about_loop + 
        ' Do you agree the current work made by another agent satisfies User\'s prompt?'
    )
